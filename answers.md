...
## Questions
1. Contributors: Jonathan Rodriguez-Gomez
...
3. Private Directory:
Directory "/project/scratch01/compile" does not exist. Only "/project/scratch01/compiling" exists and that one is just a dangling symlink.

I will continue with the steps in my home directory, which has path: "/home/compute/j.rodriguezgomez/Classes/CSE4202/cse4202-studio1".
